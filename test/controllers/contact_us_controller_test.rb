...
class ContactUsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_u" do
    assert_difference('ContactU.count') do
      post contact_us_url, params: { contact_u: { descricao: @contact_u.descricao, email: @contact_u.email, motivo: @contact_u.motivo, name: @contact_u.name, telefone: @contact_u.telefone } }
    end
  ...
  test "should update contact_u" do
    patch contact_u_url(@contact_u), params: { contact_u: { descricao: @contact_u.descricao, email: @contact_u.email, motivo: @contact_u.motivo, name: @contact_u.name, telefone: @contact_u.telefone } }
